...
/**
 * Hooks for Prescription routes
 */
export interface PrescriptionHooks {
  /**
...
/**
 * Default Prescription hooks (customize as needed)
 */
export const prescriptionHooks: PrescriptionHooks = {
