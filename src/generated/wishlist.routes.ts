...
/**
 * Auto-generated Wishlist Routes
 *
...
import type { WishlistHooks } from "./wishlist.hooks"
...
/**
 * Set hooks for Wishlist routes
 */
export function setWishlistHooks(h: WishlistHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["userId", "medicineId", "createdAt"] as const
...
/**
 * Create Wishlist CRUD routes
 */
export function createWishlistRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Wishlist not found" } }, 404)
      }
