...
/**
 * Hooks for OtpVerification routes
 */
export interface OtpVerificationHooks {
  /**
...
/**
 * Default OtpVerification hooks (customize as needed)
 */
export const otpVerificationHooks: OtpVerificationHooks = {
