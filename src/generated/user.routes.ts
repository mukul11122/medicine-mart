...
const WRITABLE_SCALAR_FIELDS = ["email", "name", "phone", "password", "role", "gender", "dateOfBirth", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["addresses", "cartItems", "orders", "prescriptions", "wishlist"] as const
