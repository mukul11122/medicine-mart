...
/**
 * Auto-generated Prescription Routes
 *
...
import type { PrescriptionHooks } from "./prescription.hooks"
...
/**
 * Set hooks for Prescription routes
 */
export function setPrescriptionHooks(h: PrescriptionHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["userId", "imageUrl", "fileName", "status", "orderId", "createdAt"] as const
...
/**
 * Create Prescription CRUD routes
 */
export function createPrescriptionRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Prescription not found" } }, 404)
      }
