...
const WRITABLE_SCALAR_FIELDS = ["name", "slug", "icon", "description", "parentId", "createdAt"] as const
const RELATION_FIELDS = ["medicines"] as const
...
export function createCategoryRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Category not found" } }, 404)
      }
